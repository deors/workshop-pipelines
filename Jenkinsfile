    ...
    stages {
        ...
        stage('Integration tests') {
            steps {
                ...
                sh "curl --retry 5 --retry-connrefused --connect-timeout 5 --max-time 5 http://${TEST_CONTAINER_NAME}:${APP_LISTENING_PORT}/${APP_CONTEXT_ROOT}"
        ...
        stage('Dependency vulnerability tests') {
            steps {
                ...
                dependencyCheckPublisher failedTotalHigh: '0', unstableTotalHigh: '0', failedTotalNormal: '5', unstableTotalNormal: '5'
            }
        }
